...
import tugaschatclient.salahPassword;
/**
 *
 * @author radityacandra
 */
public class reqPassword extends javax.swing.JFrame {

    /**
     * Creates new form reqPassword
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Silahkan masukkan password username anda pada text field di bawah ini:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reqPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new reqPassword().setVisible(true);
            }
        });
    }
